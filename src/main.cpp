 ...
 * controlling LED and Servo motor with Matter and toggle button.
 *
...
const int LED_PIN = 5;
const int TOGGLE_BUTTON_PIN = 27;
...
static esp_err_t on_attribute_update(
  ...
  if (
    ...
    // reversed because using onboard led
